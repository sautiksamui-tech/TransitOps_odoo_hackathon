...
export default function AddCustomer({ onAddCustomer, onCancel }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Check pincodes or other validations for address
      ...
      <div className="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
          <h5 className="mb-0 fw-bold">
            <i className="fas fa-user-plus me-2 text-primary"></i>Add New Customer
          </h5>
          <p className="text-muted small mb-0">Create customer profile with multiple delivery/transit addresses</p>
        </div>
      </div>
