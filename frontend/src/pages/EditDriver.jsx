...
export default function EditDriver({ driver, onEditDriver, onCancel }) {
  ...
  useEffect(() => {
    if (driver) {
      ...
      phoneNo || setPhoneNo(driver.phone_no || '');
  ...
  const handleSubmit = (e) => {
    ...
    if (!phoneNo.trim()) errs.push('Phone Contact is required.');
      ...
      <div className="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
          <h5 className="mb-0 fw-bold">
            <i className="fas fa-edit me-2 text-primary"></i>Modify Driver Profile
          </h5>
          <p className="text-muted small mb-0">Update license registration and active dispatch status</p>
        </div>
      </div>
